...
class DisneyTvShowFragment: CategoryBaseFragment<CategoryViewModel>(CategoryViewModel::class),
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        binding.labelTitle.text = requireActivity().resources.getString(com.laks.tvseries.core.R.string.disney)
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        baseViewModel.getDisneyTvShows()
    ...
    private fun bindingViewModel() {
        ...
        binding.buttonMore.setOnClickListener {
            MemoryCache.cache.setMemoryCacheValue(GlobalConstants.MOVIE_TYPE, MovieType.disneyTvShow)
    ...
    companion object {
        fun newInstance() = DisneyTvShowFragment()
    }
