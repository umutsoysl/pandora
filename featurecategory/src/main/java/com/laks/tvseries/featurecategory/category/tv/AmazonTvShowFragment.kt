...
class AmazonTvShowFragment: CategoryBaseFragment<CategoryViewModel>(CategoryViewModel::class),
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        binding.labelTitle.text = requireActivity().resources.getString(com.laks.tvseries.core.R.string.amazon)
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        baseViewModel.getAmazonTvShows()
    ...
    private fun bindingViewModel() {
        ...
        binding.buttonMore.setOnClickListener {
            MemoryCache.cache.setMemoryCacheValue(GlobalConstants.MOVIE_TYPE, MovieType.amazonTvShow)
    ...
    companion object {
        fun newInstance() = AmazonTvShowFragment()
    }
