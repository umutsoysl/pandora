...
class NetflixTvShowFragment: CategoryBaseFragment<CategoryViewModel>(CategoryViewModel::class),
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        binding.labelTitle.text = requireActivity().resources.getString(com.laks.tvseries.core.R.string.netflix)
        binding.labelSubTitle.text = requireActivity().resources.getString(com.laks.tvseries.core.R.string.tv_series)
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        baseViewModel.getNetflixTvShows()
    ...
    private fun bindingViewModel() {
        ...
        binding.buttonMore.setOnClickListener {
            MemoryCache.cache.setMemoryCacheValue(GlobalConstants.MOVIE_TYPE, MovieType.netflixTvShow)
    ...
    companion object {
        fun newInstance() = NetflixTvShowFragment()
    }
