...
import com.laks.tvseries.featurecategory.category.trend.movie.TrendMovieFragment
...
class TrendTvShowFragment: CategoryBaseFragment<TrendCategoryViewModel>(TrendCategoryViewModel::class),
    ...
    private fun bindingViewModel() {
        baseViewModel.trendingTvList.observe(requireActivity(), Observer {
