...
class AppleTvShowFragment: CategoryBaseFragment<CategoryViewModel>(CategoryViewModel::class),
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        binding.labelTitle.text = requireActivity().resources.getString(com.laks.tvseries.core.R.string.appleTv)
    ...
    private fun bindingViewModel() {
        ...
        binding.buttonMore.setOnClickListener {
            MemoryCache.cache.setMemoryCacheValue(GlobalConstants.MOVIE_TYPE, MovieType.appleTvShow)
    ...
    companion object {
        fun newInstance() = AppleTvShowFragment()
    }
